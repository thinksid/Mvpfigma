...
interface CustomerStoryCarouselProps {
  stories: CustomerStory[];
}

export const CustomerStoryCarousel: React.FC<CustomerStoryCarouselProps> = ({ stories }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-[#E2E8F0]">
        ...
        <div className="bg-gradient-to-r from-[#5b81ff] to-[#1c1c60] p-8 text-white">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-2xl mb-2">{currentStory.headline}</h3>
